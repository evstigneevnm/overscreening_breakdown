...
def main():
    ...
    for j in MM:
        N = j
        print("domain = ", N)
        solver = solve_nonlinear_problem(N, [0,np.inf], tolerance = tolerance, use_method = "newton", visualize = False, use_mpmath = use_mpmath, prec = fp_prec, use_adjoint_opimization = use_adjoint_opimization)
